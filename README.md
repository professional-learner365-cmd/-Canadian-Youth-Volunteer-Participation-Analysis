...
* What could these patterns mean for youth volunteer recruitment?

# 🛠️ Analysis Process
## 1. Data Collection
* Used Statistics Canada volunteering and Ontario Census datasets.

## 2. Data Cleaning — Google Sheets
* Organized geography, age group, reference year, volunteering definition, and measures
* Reviewed missing and suppressed values
* Standardized the data for filtering and comparison

## 3. Analysis
* Created pivot tables comparing volunteer rates and annual volunteer hours
* Compared youth with older age groups
* Compared 2018 and 2023 volunteering data
* Reviewed Census population data for youth age groups
...
* In 2023, people aged 15–24 had a higher volunteer rate, while those aged 25–34 contributed more annual volunteer hours on average.

What changed between 2018 and 2023?
* Both volunteer rates and annual volunteer hours declined between 2018 and 2023 for people aged 15–34.

What does the Census data show about the youth population?
...
* Increase youth-focused outreach through social media and schools.
* Highlight the skills and experience youth can gain through volunteering.
